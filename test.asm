...
CODE SEGMENT PARA 'CODE'
    ...
    MOV_BALL PROC NEAR
      ...
      CHECK_KEY_STROKE:
       ...
       CMP AX, BALL_X       ;MINX2
       JNG CHECK_COLLISION_WITH_LEFT_PADDLE   ;IF THERE'S NO COLLISION, CHECK FOR THE OTHER PADDLE
       
       MOV AX, BALL_X
       ADD AX, BALL_SIZE      ;MAXX2
       CMP PADDLE_RIGHT_X, AX ;MINX1
       JNL CHECK_COLLISION_WITH_LEFT_PADDLE   ;IF THERE'S NO COLLISION, CHECK FOR THE OTHER PADDLE 
